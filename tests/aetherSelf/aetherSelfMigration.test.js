...
const { createAetherSelfService,
        DEFAULT_CANONICAL_DIR } = require("../../src/services/aetherSelfService");
...
test("#1/#2/#3 migrasi byte-exact & hanya SATU path kanonik", () => {
    ...
    const svc = createAetherSelfService({
...
test("#2 journal APPEND-ONLY: entri lama tidak boleh berubah", () => {
    ...
    const svc = createAetherSelfService({ canonicalDir });
