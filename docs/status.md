...
| **Anggaran prompt: batas atas, bukan target** | 28 | `ai/tools/ToolSelector.js` | Sapaan "halo" mengirim 32 definisi tool = **1.910 token** berisi openclaw/hermes/WhatsApp/kamera — semuanya berskor **nol**, terpilih hanya karena urutan pendaftaran. Kini yang berskor nol tidak ikut |
