 ...
 *
 * Mengikuti pola config Aether yang ada (JsonStore + env fallback):
 ...
 *     env AETHER_VOICE_* dengan fallback default, dan bisa ditimpa lewat
...
function voiceConfig() {
    ...
    return {
        ...
        ttsProvider: String(envOr("AETHER_VOICE_TTS_PROVIDER", "ttsProvider", "local")),
        // Batas giliran total (ms). Nol/negatif = tanpa batas.
        maxSessionMs: num("AETHER_VOICE_MAX_SESSION_MS", "maxSessionMs", 60000),
        // Diam berapa ms dianggap selesai bicara (VAD).
        vadTimeoutMs: num("AETHER_VOICE_VAD_TIMEOUT_MS", "vadTimeoutMs", 1200),
        // Batas maksimum rekaman (ms) — jaring pengaman VAD.
        maxListenMs: num("AETHER_VOICE_MAX_LISTEN_MS", "maxListenMs", 10000),
