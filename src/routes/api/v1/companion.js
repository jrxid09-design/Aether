...
router.post("/join", deviceController.join);
...
router.post("/tts", deviceAuth, deviceController.tts);
router.post("/upload", deviceAuth, deviceController.upload);
...
router.post("/panic", deviceAuth, deviceController.panic);
...
router.post("/ai/select", deviceAuth, deviceController.select);
router.get("/ai/config", deviceAuth, aiConsoleController.config);
router.post("/ai/config", deviceAuth, aiConsoleController.saveConfig);
