 ...
 *   tier       — "ask" (butuh persetujuan) | "auto" (boleh commit langsung).
 *                Gerbang persetujuan sesungguhnya menyusul di subsistem 7
 *                (Governance); di sini baru deklarasi kebijakan.
...
const MEMORY_TYPES = {
    identity:     { storeType: "semantic",   ltm: true,  tier: "ask",  sensitive: true,  description: "Siapa pengguna, hubungan, peran." },
    preferences:  { storeType: "preference", ltm: true,  tier: "ask",  sensitive: false, description: "Kebiasaan & pilihan pengguna." },
    semantic:     { storeType: "semantic",   ltm: true,  tier: "ask",  sensitive: false, description: "Fakta dunia/pengguna yang tahan lama." },
    procedural:   { storeType: "procedural", ltm: true,  tier: "ask",  sensitive: false, description: "Cara/alur kerja/runbook." },
    project:      { storeType: "semantic",   ltm: true,  tier: "ask",  sensitive: false, description: "Tujuan, keputusan, status proyek." },
    goals:        { storeType: "semantic",   ltm: true,  tier: "ask",  sensitive: false, description: "Sasaran aktif pengguna." },
