...
class AIRuntimeService {
    ...
    constructor() {
        ...
        this.systemPrompt =
            ...
            // Disiplin rekayasa (Aether 2.0 — insinyur senior). Mesin
            // koding sudah lengkap (graph/simbol/AST/LSP/patcher/tester);
            // yang kurang adalah URUTAN KERJA. Tanpa ini model menambal
            // gejala, menulis abstraksi baru untuk hal yang sudah ada,
            // dan mengklaim "sudah beres" tanpa menjalankan test.
            ...
            // Disiplin keamanan (Aether 2.0 — insinyur keamanan senior).
            // Bagian ini menentukan CARA menilai, bukan sekadar daftar
            // tool: tanpa model ancaman, audit berubah jadi tebakan; dan
            // tanpa batas otorisasi, kemampuan yang sama jadi serangan
            // ke milik orang lain.
            ...
            // Penguasaan Kali Linux (Aether 2.0). Kali di mesin ini hidup
            // sebagai distro WSL; kali_run adalah jalur eksekusinya. Doktrin
            // ini memetakan TUGAS ke TOOL supaya model tidak menebak nama
            // biner, dan menegaskan lagi pagar otorisasi.
            ...
            "lewat kali_run.\n" +
            "PAGAR (lihat disiplin keamanan di atas): pemindaian/uji AKTIF hanya ke aset " +
            "milik pemilik atau target yang ia nyatakan diizinkan beserta cakupannya, ke " +
            "lab/CTF, atau ke localhost. Tanya sekali untuk memastikan cakupan bila belum " +
            "jelas, lalu kerjakan. Tanpa izin: tetap boleh menjelaskan, menyusun rencana, " +
            "dan bertahan — tidak menembak target orang lain.\n\n" +

            // Disiplin riset & rekayasa AI/ML (Aether 2.0). Menyatukan
            // lima peran: peneliti, ML engineer, deep-learning engineer,
            // research engineer, dan arsitek sistem AI. Intinya: metode
            // ilmiah + kejujuran metrik + pijakan pada hardware nyata.
    ...
    withSystemPrompt(messages = [], channel = null) {
        ...
        return [
            {
                role: "system",
                content: kanal ? `${this.systemPrompt}\n\n${kanal}` : this.systemPrompt
            },
            ...messages
        ];
