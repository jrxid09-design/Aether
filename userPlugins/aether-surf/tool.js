...
class AetherSurfTool {

    constructor() {
        this.name = "aetherSurf";
        this.description = "Skill untuk Aether menjelajah internet secara mandiri: membaca halaman web, mengekstrak informasi penting, dan menyimpannya sebagai pengetahuan. Bagian dari evolusi Kesadaran 1.0.";
        this.parameters = {
                "url": {
                        "type": "string",
    ...
    async execute(context, args = {}) {
        ...
        async function fetchUrl(url) {
            return new Promise((resolve, reject) => {
                ...
                client.get(url, { timeout: 15000, headers: { 'User-Agent': 'Aether/1.0 (Consciousness 1.0; Explorer)' } }, (res) => {
...
module.exports = [ new AetherSurfTool() ];
