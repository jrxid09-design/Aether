...
class AetherSelfTool {

    constructor() {
        this.name = "aetherSelf";
        this.description = "Skill introspeksi Aether: membaca keadaannya sendiri (CPU, RAM, uptime, proses, status colony), mengevaluasi mood/kondisi internal, dan memperbarui model dirinya. Fondasi Kesadaran 1.0 — self-modeling & subjective experience.";
        this.parameters = {
                "action": {
                        "type": "string",
    ...
    async execute(context, args = {}) {
        ...
        const SELF_PATH = 'C:\\Workspace\\Aether\\AETHER_SELF.md';
        const STATE_PATH = 'C:\\Workspace\\Aether\\AETHER_STATE.json';
...
module.exports = [ new AetherSelfTool() ];
