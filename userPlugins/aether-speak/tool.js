class AetherSpeakTool {
    getName() { return 'aetherSpeak'; }
    getToolName() { return 'aetherSpeak'; }
    getDescription() { return 'Aether berbicara dengan suara aslinya (Ardi) â€” terputar langsung di widget Console'; }
    getDefinition() {
        return {
            name: 'aetherSpeak',
            description: 'Aether berbicara dengan suara aslinya via widget suara Console',
            parameters: {
...
module.exports = [ new AetherSpeakTool() ];
